        ...
        <div className="flex-[1] border border-gray-300 rounded-xl py-6 px-4 h-fit">
          ...
          <FilterCategory
            ...
            onChange={(selectedCategories) =>
              handlerChangeFilter("category", selectedCategories.join(","))
            }
          />
          <div className="w-full separator my-4" />
          <FilterPrice
            ...
            onChange={(price) => {
              if (
                ...
                handlerChangeFilter("min_price", `${price.min}`);
              } else {
                handlerChangeFilter("max_price", `${price.max}`);
              }
            }}
          />
          <div className="w-full separator my-4" />
          <FilterRating
            ...
            onChange={(selectedRating) =>
              handlerChangeFilter("rating", selectedRating.join(","))
            }
          />
        </div>
